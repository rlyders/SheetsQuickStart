...
public class SheetsQuickstart {
    ...
    private static Credential getCredentialsForClientSecret(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        if (in == null) {
            throw new FileNotFoundException("Client secret file (for web application) resource not found: " + CLIENT_SECRET_PATH);
        }
    ...
    private static Credential getCredentialsForServiceAccount() throws IOException {
        InputStream in = SheetsQuickstart.class.getResourceAsStream(CREDENTIALS_PATH);
        if (in == null) {
            throw new FileNotFoundException("Credentials file resource (for Google service account) not found: " + CREDENTIALS_PATH);
        }
